...
export const DEPARTMENT_STRUCTURE_DEFAULTS: DepartmentStructure = {
  ...
  // Розміщення апаратів по кабінетах — за офіційним переліком в/ч А3120
  // (запит на технічні паспорти, 2026).
  rooms: [
    ...
    { id: "xray", name: "Рентгенодіагностичний кабінет №1", devices: [
      { name: "Рентгенівська система Sireskop-CX", kind: "Рентген", details: "В експлуатації з 1998 року" },
      ...
      { name: "Мобільна рентгенівська система PLX 102", kind: "Пересувний", details: "В експлуатації з 2011 року" },
      { name: "Апарат рентгенівський діагностичний пересувний М32", kind: "Пересувний", details: "В експлуатації з 2022 року" },
    ] },
    { id: "dental", name: "Рентгенодіагностичний кабінет №2", devices: [
      { name: "Панорамний рентгенапарат HYPERION X9 Pro", kind: "Панорамний" },
      { name: "Внутрішньоротова рентгенівська система RXDC", kind: "Дентальний" },
      { name: "Рентгенівська діагностична система IMAX 6000", kind: "Цифровий" },
    ] },
    { id: "fluoro", name: "Флюорографічний кабінет", devices: [
      { name: "Цифровий флюорограф 12Ф9-Україна", kind: "Флюорограф", details: "Перенесено до флюорографічного кабінету" },
    ] },
    { id: "mobile", name: "Пересувний рентгенівський кабінет (на базі ЗІЛ-130)", devices: [
      { name: "Пересувний флюорограф СЕРИКС 71", kind: "Флюорограф", details: "На базі автомобіля ЗІЛ-130" },
    ] },
