...
export const SITE_CONTENT_DEFAULTS: SiteContent = {
  ...
  slogan: "КТ, рентген, флюорографія — до 54 досліджень за робочий день і близько 16 000 на рік.",
  ...
  about: "Відділення променевої діагностики Чернігівського військового госпіталю — до 54 досліджень за робочий день і близько 16 000 на рік. Щодня: комп’ютерна томографія — до 16, цифрова рентгенографія — до 16, флюорографія — до 22 досліджень. Роботу виконують дев’ять діагностичних апаратів, зокрема сучасні комп’ютерні томографи SOMATOM. Військовослужбовцям — безоплатно за направленням, цивільним особам — платно з онлайн-записом. Невідкладна допомога — цілодобово.",
