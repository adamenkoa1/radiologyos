...
export const SITE_CONTENT_DEFAULTS: SiteContent = {
  ...
  slogan: "Понад 35 видів досліджень — КТ, рентген, флюорографія. Сучасна променева діагностика в Чернігові.",
  ...
  about: "Відділення променевої діагностики Чернігівського військового госпіталю — понад 35 видів досліджень за 6 напрямками: комп’ютерна томографія (без контрастування, з контрастуванням і КТ-ангіографія), цифрова рентгенографія, флюорографія та контрастні дослідження. У відділенні — дев’ять діагностичних апаратів, зокрема сучасні комп’ютерні томографи SOMATOM. Військовослужбовцям — безоплатно за направленням, цивільним особам — платно з онлайн-записом. Невідкладна допомога — цілодобово.",
