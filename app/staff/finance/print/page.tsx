...
export default function FinancePrintPage(){
  ...
  return <main className="financePrintPage"><div className="financePrintToolbar"><button onClick={()=>window.close()}>Закрити</button><button onClick={()=>window.print()}>Друкувати / PDF</button></div><article className="financePrintSheet">
