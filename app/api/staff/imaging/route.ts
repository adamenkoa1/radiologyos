...
async function checkPacsPatientIdentity(
  ...
  // The booking code is the canonical accession generated by RadiologyOS and is
  // sufficient to preserve safe access to historical studies created before the
  // immutable MWL PatientID migration. Custom accessions need the stronger
  // PatientID binding below.
  ...
  if (!expectedPatientId) return { ok:false, reason:"patient_identity_unverified" };
