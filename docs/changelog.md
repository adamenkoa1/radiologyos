...
### Planned
- Перенесення внутрішніх сторінок на стандартні BAS-подібні журнал/довідник/документ форми.
- Реальний posting engine та tenant-scoped регістри для послуг, оплат, складу, виробітку й навантаження обладнання.
- Єдиний реєстр версійних друкованих форм і PDF/snapshot pipeline.
